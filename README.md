...
## Documentation
The documentation have been written in a doxygen-compatible format and can be viewed either normally in the source code or through the [doxygen generated HTML](https://cappe04.github.io/cpp-json-parser/). If the file is missing it can be generated by running:
```
doxygen Doxyfile
```
